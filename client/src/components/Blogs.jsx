...
export default class Blogs extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedBlog: '',
      blogs: [],
      // ToDo: Refactor once blogs are fetched from back end
  ...
  componentDidUpdate() {
    let selectedRegionBlogs = [];
    if (this.props.navSelection !== this.state.selectedRegion) {
      for (let blog of this.state.allBlogs) {
        if (blog.region === this.props.navSelection) {
